...
class AppTheme {
  ...
  // 2. Accent Colors
  static const Color accentCoral = Color(0xFFFF6F61);  // Coral Red - alerts, errors, urgent notifications
  static const Color accentMint = Color(0xFF00C49A);   // Mint Green - success, positive stats, earnings
  static const Color accentYellow = Color(0xFFFFD54F); // Warm Yellow - highlights, promotions
  
  // 3. Neutral / Base Colors
  static const Color backgroundLight = Color(0xFFF8F9FB);  // Off-white - main background
  static const Color backgroundDark = Color(0xFF1A1A2E);   // Rich Navy Black - dark mode
  static const Color textPrimary = Color(0xFF212121);     // Dark Charcoal - high readability
  static const Color textSecondary = Color(0xFF6E6E6E);   // Medium Gray - captions, hints
  static const Color dividerColor = Color(0xFFE0E0E0);    // Soft Gray - borders, dividers
