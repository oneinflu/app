...
class ChannelBenefitsScreen extends StatelessWidget {
  const ChannelBenefitsScreen({Key? key}) : super(key: key);
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                _buildBenefitItem(
                  icon: Icons.tv,
                  title: 'Launch Your Own Channel',
                  description:
                      'No approvals, no waiting. Just create and start teaching',
                ...
                _buildBenefitItem(
                  ...
                  title: 'Earn from Day 1 — No Followers Needed',
                  description:
                      'Get paid per course, per student, or through collaborations.',
                ...
                _buildBenefitItem(
                  icon: Icons.school,
                  title: 'Host Live Classes, Offer Certifications',
                  description: 'All tools in one platform — teach your way.',
                ...
                _buildBenefitItem(
                  ...
                  title: 'Get Discovered via INFLU Feed',
                  description:
                      'INFLU pushes your content to real businesses & learners.',
        ...
        child: ElevatedButton(
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const VerificationScreen(sourceScreen: 'channel'),
              ),
            );
          },
